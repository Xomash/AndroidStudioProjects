            ...
            builder.setMessage("Тест пройдено!")
                    ...
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            Intent myIntent = new Intent(Elimination.this, MainActivity.class);
                            Elimination.this.startActivity(myIntent);
                        }
                    });
    ...
    private class Client extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            try {
                ...
                client = new Socket("192.168.219.1", 4444); // connect to the server
